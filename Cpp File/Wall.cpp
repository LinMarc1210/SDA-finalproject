...
Wall::Wall(char type)
{
    ...
    switch(type)
    {
        case 'b':
            ...
            setPixmap(QPixmap(":/image/Brick_Wall.png"));
            break;
        case 's':
            walltype = Walltype::STEEL;
            setPixmap(QPixmap(":/image/Steel_Wall.png"));
            break;
        case 't':
            walltype = Walltype::TREE;
            setPixmap(QPixmap(":/image/Trees.png"));
            break;
        case 'w':
            walltype = Walltype::WATER;
            setPixmap(QPixmap(":/image/Water.png"));
            break;
        case 'i':
            walltype = Walltype::ICE;
            setPixmap(QPixmap(":/image/Ice.png"));
            break;
    }
